...
include_once('C:\wamp64\www\Bilisim\login\connection.php');
...
<body>
	<div class="container">
        <div  style="display: inline-grid;background-color: #47484e;border-radius: 10px 10px 10px 10px;width: 45%;height: 100px;margin-bottom: 20px;box-shadow: 10px 10px 8px 10px #bbbbbb;margin-top: 20px">
        ...
        <div  style="display: inline-grid;background-color: #81818e;border-radius: 10px 10px 10px 10px;width: 45%;height: 100px;margin-bottom: 20px;box-shadow: 10px 10px 8px 10px #bbbbbb; ">
				...
				if (isset($_POST['user_name']) && isset($_POST['user_password'])) {
					...
					if ($result != false) {
						if ($result->num_rows > 0) {
							...
							header('Location: http://localhost/contents/admin-content/content.php');
						} else {
							echo $fault_alert;
						}
					} else {
